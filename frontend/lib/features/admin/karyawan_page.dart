  ...
  Widget build(BuildContext context) {
    ...
    return Stack(children: [
      ...
      if (showForm) Positioned.fill(child: GestureDetector(onTap: () => setState(() => showForm = false), child: Container(color: Colors.black54, alignment: Alignment.center,
        child: GestureDetector(onTap: () {}, child: Material(color: cs.surfaceBright, borderRadius: BorderRadius.circular(16), elevation: 8, child: Container(width: 400, padding: const EdgeInsets.all(24),
