...
class _CartItemWidgetState extends State<CartItemWidget> {
  ...
  void _startEdit() {
    ...
    _editCtrl.text = qty == (qty as num).roundToDouble() ? '${qty.round()}' : qty.toString();
  ...
  Widget build(BuildContext context) {
    ...
    final unitPrice = (widget.item['unit_price'] as num).toDouble();
    final quantity = (widget.item['quantity'] as num).toDouble();
